...
import styles from "../../styles/buttons/button-hovers.module.css";
        ...
        <div>
          <div className={btnDefault}>
            <div className={button}>
              <button className={classNames({[btn_default_large]:true, [btnPrimary]: true})} style={{borderRadius: "16px"}} id="button-primary" disabled={true}>
                Primary | Disabled
              </button>
            ...
            <div className={button}>
              ...
              <button className={classNames({[btn_default_medium]:true, [btnSuccess]:true})} style={{borderRadius: "16px"}} id="button-success" disabled={true}>
                Success | Disabled
              </button>
            </div>
            ...
            <div className={button}>
              ...
              <button className={classNames({[btn_default_small]:true, [btnSecondary]:true})} style={{borderRadius: "16px"}} id="button-secondary" disabled={true}>
                Secondary
              </button>
